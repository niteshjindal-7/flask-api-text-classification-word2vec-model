...
wordembedding_dir = "/home/nitesh/Documents/AMPBA/AISPRY/WordEmbeddings/"
...
K=5
content= list(map(lambda f: str(list(f.values())).split(),l))
...
model = Word2Vec(sentences,vector_size=embeddingsize, window=win_size,compute_loss=True,min_count=2, workers=1, epochs=70,callbacks=[loss_logger])   
